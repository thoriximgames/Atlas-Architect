    ...
    try {
        switch (cmd) {
            case 'list':
                ...
                break;
            case 'create':
                await PipelineManager.create(arg1);
                break;
            case 'sync':
                await PipelineManager.sync();
                break;
            case 'start':
                await PipelineManager.move(arg1, '02_in_progress');
                break;
            case 'review':
                await PipelineManager.move(arg1, '03_review');
                break;
            case 'complete':
                await PipelineManager.move(arg1, '04_completed');
                break;
            case 'todo':
                await PipelineManager.move(arg1, '01_todo');
                break;
